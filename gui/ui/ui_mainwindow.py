...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon7 = QIcon()
        icon7.addFile(u":/assets/recent.png", QSize(), QIcon.Normal, QIcon.Off)
        self.recentFilesMenu.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/assets/create_team.png", QSize(), QIcon.Normal, QIcon.Off)
        self.createTeamBtn.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/assets/sorting_hat.png", QSize(), QIcon.Normal, QIcon.Off)
        self.assignTeamsBtn.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/assets/list.png", QSize(), QIcon.Normal, QIcon.Off)
        self.gradesBtn.setIcon(icon10)
