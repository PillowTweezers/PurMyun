...
from gui.FancySlider import FancySlider
...
class Ui_StatsWidget(object):
    def setupUi(self, StatsWidget):
        ...
        self.squareSlider = FancySlider(StatsWidget)
        ...
        self.crossSlider = FancySlider(StatsWidget)
        ...
        self.parallelSlider = FancySlider(StatsWidget)
        ...
        self.tripodSlider = FancySlider(StatsWidget)
        ...
        self.anchoringSlider = FancySlider(StatsWidget)
        ...
        self.macrameSlider = FancySlider(StatsWidget)
